...
namespace MyApp.UserService.Api.Extensions;
...
public static class ApiExtensions
{
    public static IServiceCollection AddApiExtensions(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            ...
            .AddDbContextCheck<MyApp.UserService.Infrastructure.Persistence.ApplicationDbContext>();
        ...
        services.AddSwaggerGen(c =>
        {
            c.SwaggerDoc("v1", new OpenApiInfo
            {
                ...
                Version = "v1",
                Description = "API for TestProject microservice",
