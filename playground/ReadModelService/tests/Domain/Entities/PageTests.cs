...
var id = Guid.NewGuid();
        ...
        // Act
        var entity = new Page(id, createdAt, updatedAt);
    ...
    [Fact]
    public void Constructor_ShouldRaisePageCreatedEvent()
    {
        // Arrange
var id = Guid.NewGuid();
        var createdAt = DateTime.UtcNow;
    ...
    {
        // Arrange
        var entity = new PageBuilder().Build();
    ...
    [Theory]
    [AutoData]
    public void Constructor_WithBuilder_ShouldCreateValidEntity(PageBuilder builder)
    {
        // Act
