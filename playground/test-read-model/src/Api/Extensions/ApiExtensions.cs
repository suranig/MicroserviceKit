...
public static class ApiExtensions
{
    public static IServiceCollection AddApiExtensions(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            ...
            .AddDbContextCheck<ReadModelService.Infrastructure.Persistence.ApplicationDbContext>();
        ...
        services.AddSwaggerGen(c =>
        {
            ...
            {
                Title = "ReadModelService API",
                Version = "v1",
                Description = "API for ReadModelService microservice",
