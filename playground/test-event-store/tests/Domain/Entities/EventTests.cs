...
namespace EventStoreService.UnitTests.Domain.Entities;
...
var id = Guid.NewGuid();
        ...
        // Act
        var entity = new Event(id, name, description);
    ...
    [Fact]
    public void Constructor_ShouldRaiseEventCreatedEvent()
    {
        // Arrange
var id = Guid.NewGuid();
        var name = "Test Value";
    ...
    {
        // Arrange
        var entity = new EventBuilder().Build();
    ...
    [Theory]
    [AutoData]
    public void Constructor_WithBuilder_ShouldCreateValidEntity(EventBuilder builder)
    {
        // Act
