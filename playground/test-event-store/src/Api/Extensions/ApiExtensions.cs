...
namespace EventStoreService.Api.Extensions;
...
public static class ApiExtensions
{
    public static IServiceCollection AddApiExtensions(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            ...
            .AddDbContextCheck<EventStoreService.Infrastructure.Persistence.ApplicationDbContext>();
        ...
        services.AddSwaggerGen(c =>
        {
            ...
            {
                Title = "EventStoreService API",
                Version = "v1",
                Description = "API for EventStoreService microservice",
