...
namespace SimpleService.Api.Extensions;
...
public static class ApiExtensions
{
    public static IServiceCollection AddApiExtensions(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            ...
            .AddDbContextCheck<SimpleService.Infrastructure.Persistence.ApplicationDbContext>();
        ...
        services.AddSwaggerGen(c =>
        {
            c.SwaggerDoc("v1", new OpenApiInfo
            {
                ...
                Version = "v1",
                Description = "API for SimpleService microservice",
